...
Axiom bitv_eq : forall (b1:bitv) (b2:bitv), (forall (x:Z), ((mixfix_lbrb b1
  x) = (mixfix_lbrb b2 x))) <-> (infix_eqeq b1 b2).
...
(* Why3 goal *)
Theorem not16_gate_correct_equiv : forall (a1:bitv), (infix_eqeq (map a1)
  (notbv a1)).
intros a1.
rewrite <- bitv_eq.
intros.
